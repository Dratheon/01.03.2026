...
class SupplierCreate(BaseModel):
    ...
    supplyType: str = "stock"  # stock | glass | production
    jobRoleId: str | None = None  # Hangi iş koluna ait
...
class SupplierUpdate(BaseModel):
    ...
    type: str | None = None
    category: str | None = None
    supplyType: str | None = None  # stock | glass | production
    jobRoleId: str | None = None  # Hangi iş koluna ait
    contact: SupplierContact | None = None
...
def update_supplier(supplier_id: str, payload: SupplierUpdate, authorization: Optional[str] = Header(None)):
    ...
    for idx, supplier in enumerate(suppliers):
        if supplier.get("id") == supplier_id:
            ...
            if payload.supplyType is not None:
                supplier["supplyType"] = payload.supplyType
            if payload.jobRoleId is not None:
                supplier["jobRoleId"] = payload.jobRoleId
